...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction3() {
    final Multiplication mult =
        new Multiplication(
            new Division(new Literal(9), new Variable("x", 1.0)), new Variable("y", 1.0));
  ...
  public void shouldListVariablesFunction4() {
    final Power pow =
        new Power(new Division(new Literal(27), new Variable("a", 1.0)), new Variable("b", 1.0));
  ...
  public void shouldListVariablesFunction5() {
    final Power pow =
        new Power(new Variable("z", 1.0), new Division(new Literal(1), new Literal(2)));
    List<String> result = pow.accept(listVariableVisitor);
  ...
  public void shouldListVariablesFunction8() {
    final Multiplication mult =
        new Multiplication(new Sum(new Literal(5), new Variable("i", 1.0)), new Literal(8));
    List<String> result = mult.accept(listVariableVisitor);
